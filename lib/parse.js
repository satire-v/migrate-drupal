...
const getDrupal = drupal => drupal.getAllArticles();
...
async function main() {var _argv$articleCount;
  ...
  drupal.createMainBar((_argv$articleCount = argv.articleCount) !== null && _argv$articleCount !== void 0 ? _argv$articleCount : articles.length);
